...
class BenchmarkParser extends Parser {
    ...
    parse(output) {
        ...
        while (curItr.done !== true) {
            ...
            if (
                (curRegexResult = benchmarkNameRegex.exec(curItr.value)) !==
                null
            ) {
            ...
            if (
                (curRegexResult = benchmarkVariantRegex.exec(curItr.value)) !==
                null
            ) {
            ...
            // Parse test Data
            const benchmarkParserKey =
                Utils.getBenchmarkParserKey(curBenchmarkName);
