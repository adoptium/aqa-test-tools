...
export default class GitNewissue extends Component {
        ...
        if (testResult === 'FAILED') {
            ...
            for (let i = 0; i < response.length; i++) {
                ...
                if (previousResult === 'PASSED') {
                    ...
                    machinesMap[previousMachine] = machinesMap[previousMachine]
    ...
    render() {
        ...
        const { testId, testName, buildId } = getParams(
                ...
                <Card
                    ...
                    extra={
                        <Tooltip title="Create new issue at https://github.com/AdoptOpenJDK/openjdk-tests">
                            <a
                                href={`https://github.com/AdoptOpenJDK/openjdk-tests/issues/new${urlParams}`}
                                target="_blank"
