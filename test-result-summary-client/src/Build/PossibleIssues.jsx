    ...
    async fetchIssues() {
        ...
        if (response.ok) {
            ...
            for (let index = 0; index < relatedIssues.items.length; index++) {
                ...
                const issue_created_by = <a href={relatedIssues.items[index].user.html_url} target="_blank" rel="noopener noreferrer">{relatedIssues.items[index].user.login}</a>;
    ...
    render() {
        ...
        if (error) {
            ...
            const columns = [
                ...
                {
                    title: 'Issue Creator',
                    dataIndex: 'issue_created_by',
                    key: 'issue_created_by',
                },
                {
